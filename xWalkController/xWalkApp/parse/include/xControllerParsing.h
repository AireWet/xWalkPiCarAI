 ...
 * implementation. */
#define XWALK_FORMAT_LINE_TRACKING_STATE(STATE)                                \
  ::xwalk::ctrl::formatLineTrackingState((STATE))

/** @brief Formats detection geometry through the Controller parsing
 * implementation. */
#define XWALK_FORMAT_DETECTION(DETECTION)                                      \
  ::xwalk::ctrl::formatDetection((DETECTION))
