...
class XWalkController
{
    ...
    public:
         ...
         */
        friend ::ctrl::int32 XWALK_runPicarxControllerCommand(
            XWalkController& controller,
         ...
         */
        XWalkController(agent::XWalkPicarx& picarx, ::ctrl::contextpointer context,
        ...
        XWalkController(agent::XWalkPicarx& picarx, agent::XWalkBullFight& bullFight,
            ::ctrl::contextpointer context,
            const XWalkControllerCallbacks& backendCallbacks);
        ...
        XWalkController(agent::XWalkPicarx& picarx, agent::XWalkVideoCar& videoCar,
            ::ctrl::contextpointer context,
            const XWalkControllerCallbacks& backendCallbacks);
         ...
         * @param[in] backendCallbacks Complete non-null synchronous callback table.
         */
        XWalkController(agent::XWalkPicarx& picarx, agent::XWalkSelfDrive& selfDrive,
            ::ctrl::contextpointer context, const XWalkControllerCallbacks& backendCallbacks);
        ...
        XWalkController(agent::XWalkPicarx& picarx, agent::XWalkGptCar& gptCar,
            ::ctrl::contextpointer context,
            const XWalkControllerCallbacks& backendCallbacks);
