...
XWalkController::XWalkController(agent::XWalkPicarx& picarx,
    ...
    moveExampleObject(&moveExample),
    keyboardControlObject(&keyboardControl),
    obstacleAvoidanceObject(&obstacleAvoidance),
    cliffDetectionObject(&cliffDetection),
...
XWalkController::XWalkController(agent::XWalkPicarx& picarx,
    agent::XWalkVideoCar& videoCar, ::ctrl::contextpointer context,
    const XWalkControllerCallbacks& backendCallbacks):
    picarxObject(&picarx), videoCarObject(&videoCar), callbackContext(context),
    callbacks(backendCallbacks)
{
    validateCallbacks(callbacks);
}
...
XWalkController::XWalkController(agent::XWalkPicarx& picarx,
    agent::XWalkAppControl& appControl, ::ctrl::contextpointer context,
    const XWalkControllerCallbacks& backendCallbacks):
    picarxObject(&picarx), appControlObject(&appControl), callbackContext(context),
    callbacks(backendCallbacks)
{
    validateCallbacks(callbacks);
}
...
XWalkController::XWalkController(
    ...
    ::ctrl::contextpointer context,
    const XWalkControllerCallbacks& backendCallbacks):
    soundBackgroundMusicObject(&soundBackgroundMusic), callbackContext(context),
    callbacks(backendCallbacks)
{
    validateCallbacks(callbacks);
}
...
XWalkController::XWalkController(agent::XWalkPicarx& picarx,
    ...
    ::ctrl::contextpointer context, const XWalkControllerCallbacks& backendCallbacks)
...
XWalkController::XWalkController(agent::XWalkPicarx& picarx,
    agent::XWalkFaceTracking& faceTracking, ::ctrl::contextpointer context,
    const XWalkControllerCallbacks& backendCallbacks):
...
XWalkController::XWalkController(agent::XWalkPicarx& picarx,
    agent::XWalkBullFight& bullFight, ::ctrl::contextpointer context,
    const XWalkControllerCallbacks& backendCallbacks):
 ...
 */
XWalkController::XWalkController(agent::XWalkPicarx& picarx,
    agent::XWalkTreasureHunt& treasureHunt, ::ctrl::contextpointer context,
    const XWalkControllerCallbacks& backendCallbacks):
...
XWalkController::XWalkController(agent::XWalkPicarx& picarx,
    agent::XWalkVoicePromptCar& voicePromptCar, ::ctrl::contextpointer context,
    const XWalkControllerCallbacks& backendCallbacks)
...
XWalkController::XWalkController(agent::XWalkPicarx& picarx,
    agent::XWalkVoiceActiveCar& voiceActiveCar, ::ctrl::contextpointer context,
    const XWalkControllerCallbacks& backendCallbacks)
