...
{
    printf '%s\n' \
        "Usage: xWalkTool/shell-agent/repo-tool/clean-build.sh [--dry-run] [--yes]" \
        "" \
...
if [ ! -f "${REPOSITORY_ROOT}/xWalk-rpi5/CMakeLists.txt" ] ||
    [ ! -f "${REPOSITORY_ROOT}/xWalk-rpi5/xWalkHal/interface/xWalkI2c/CMakeLists.txt" ] ||
