...
```bash
ANSIBLE_HOME="$PWD/build-host/ansible" ANSIBLE_LOCAL_TEMP="$PWD/build-host/ansible/local" ansible-playbook --syntax-check xWalkTool/shell-agent/env-tool/playbooks/zuul/run-host-quality-job.yaml
```

```bash
ANSIBLE_HOME="$PWD/build-host/ansible" ANSIBLE_LOCAL_TEMP="$PWD/build-host/ansible/local" ansible-playbook --syntax-check xWalkTool/shell-agent/env-tool/playbooks/zuul/collect-host-quality-artifacts.yaml
```
