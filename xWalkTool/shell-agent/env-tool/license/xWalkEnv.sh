...
_xwalk_load_environment() {
    ...
    license_tool="$repository_root/xWalkTool/py-agent/dev-tool/xWalkLicenseTool"
    template_file="$repository_root/xWalkTool/shell-agent/env-tool/license/xWalkLicense.cfg"
