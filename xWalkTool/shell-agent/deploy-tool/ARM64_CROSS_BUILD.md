...
cmake --fresh -S xWalk-rpi5 --preset aarch64-rpi-release
...
```sh
cmake -S xWalk-rpi5 -B build-aarch64 -DCMAKE_TOOLCHAIN_FILE=xWalk-rpi5/cmake/toolchains/aarch64-linux-gnu.cmake -DXWALK_AARCH64_SYSROOT=/absolute/path/to/arm64-sysroot -DXWALK_BUILD_RPI=ON -DBUILD_TESTING=OFF -DCMAKE_BUILD_TYPE=Release
...
```sh
cmake -S xWalk-rpi5 -B build-aarch64 -DCMAKE_TOOLCHAIN_FILE=xWalk-rpi5/cmake/toolchains/aarch64-linux-gnu.cmake -DXWALK_AARCH64_SYSROOT=/absolute/path/to/arm64-sysroot -DXWALK_BUILD_RPI=ON -DXWALK_ENABLE_PACKAGING=ON -DBUILD_TESTING=OFF -DCMAKE_BUILD_TYPE=Release
