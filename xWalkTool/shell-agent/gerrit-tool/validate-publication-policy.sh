...
service_path="xWalkTool/py-agent/gerrit-tool/py-src/xWalkGerritCi.py"
helper_path="xWalkTool/py-agent/gerrit-tool/shell-script/gerrit-github-sync.sh"
validator_path="xWalkTool/shell-agent/gerrit-tool/validate-publication-policy.sh"
