...
chmod +x xWalkTool/py-agent/dev-tool/styler-tool/xWalkStyler
```
...
xWalkTool/py-agent/dev-tool/styler-tool/xWalkStyler format xWalk-rpi5/xWalkHal
xWalkTool/py-agent/dev-tool/styler-tool/xWalkStyler check
xWalkTool/py-agent/dev-tool/styler-tool/xWalkStyler check xWalk-rpi5/xWalkAgent
xWalkTool/py-agent/dev-tool/styler-tool/xWalkStyler format-file "source directory/example.cpp"
xWalkTool/py-agent/dev-tool/styler-tool/xWalkStyler check-file "source directory/example.cpp"
xWalkTool/py-agent/dev-tool/styler-tool/xWalkStyler --help
```
...
```sh
python3 xWalkTool/py-agent/dev-tool/styler-tool/tests/test_xWalkStyler.py
shellcheck xWalkTool/py-agent/dev-tool/styler-tool/xWalkStyler
```
