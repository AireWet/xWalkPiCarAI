...
void XWalkMusicHostStub::playSound(contextpointer context, stringview filename,
...
void XWalkMusicHostStub::playMusic(contextpointer context, stringview filename,
...
void XWalkMusicHostStub::setMusicVolume(contextpointer context,
...
float64 XWalkMusicHostStub::getSoundLength(contextpointer context,
                                           stringview filename) {
...
void XWalkMusicHostStub::playTone(contextpointer context,
  ...
  XWALK_HAL_TRACE_UID1(RPI .302, "Music host stub accepted %zu PCM tone bytes",
                       pcmData.size());
}
...
uint32 XWalkMusicHostStub::toneCount() const noexcept { return toneCountValue; }
