...
class XWalkMusicAlsa final
{
    ...
    protected:
         ...
         */
        void writeAudio(const XWalkMusicAlsaAudioData& audioData, size startFrame,
            int32 loopCount, boolean observeMusicState, boolean observeSoundState);
        /**
         ...
         */
        static void playSound(contextpointer context, stringview filename,
         ...
         * Optional normalized mixer volume from zero through one.
         */
        static void playSoundBackground(contextpointer context, stringview filename,
            optionalfloat64 normalizedVolume);
        /**
         ...
         */
        static void playMusic(contextpointer context, stringview filename,
         ...
         */
        static void playTone(contextpointer context, const bytevector& pcmData,
    ...
    public:
         ...
         */
        XWalkMusicAlsa(XWalkAudioAlsa& sharedAudioBackend, contextpointer context,
