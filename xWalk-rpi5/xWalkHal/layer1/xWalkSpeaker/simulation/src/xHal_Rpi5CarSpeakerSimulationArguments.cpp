...
{
XWalkSpeakerSimulationArguments::XWalkSpeakerSimulationArguments(
...
boolean XWalkSpeakerSimulationArguments::valid() const noexcept { return validValue; }
...
void XWalkSpeakerSimulationArguments::parseSelector(stringview selector)
{
    ...
    const stringview enableSuffix(".enable"); const stringview disableSuffix(".disable");
