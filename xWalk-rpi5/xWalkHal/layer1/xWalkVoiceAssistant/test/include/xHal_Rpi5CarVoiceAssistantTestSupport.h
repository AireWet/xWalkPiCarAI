...
{
struct TestGpioBackend { boolean value{}; };
struct TestI2cBackend { uint32 readCount{}; };
struct TestPrimeBackend { uint32 callCount{}; };
struct TestRecognitionBackend
{
    string result{"where am I"}; uint32 listenCount{}; uint32 stopCount{};
};
struct TestModelBackend
{
    string instructions{}; string promptText{}; string imagePath{};
    string response{"raw response"}; uint32 promptCount{};
};
struct TestOutputBackend { string text{}; uint32 callCount{}; };
struct TestHookBackend
{
    string heard{}; string spoken{}; uint32 startCount{};
    uint32 roundCount{}; uint32 stopCount{};
};
