...
{
    static_cast<void>(context); static_cast<void>(timeoutMs); return "simulated recognition";
}
...
{
    static_cast<void>(text); ++static_cast<XWalkGptHostStub*>(context)->spokenCountValue;
}
void XWalkGptHostStub::configureGpio(contextpointer context, uint8 pin,
...
{
    static_cast<void>(pin); return static_cast<XWalkGptHostStub*>(context)->gpioValueValue;
}
void XWalkGptHostStub::writeGpio(contextpointer context, uint8 pin, boolean value)
{
    static_cast<void>(pin); static_cast<XWalkGptHostStub*>(context)->gpioValueValue = value;
}
void XWalkGptHostStub::interruptGpio(contextpointer context, uint8 pin, XWalkGpioEdge edge,
...
void XWalkGptHostStub::writeI2c(contextpointer context, uint8 address, uint8 reg,
...
boolean XWalkGptHostStub::gpioValue() const noexcept { return gpioValueValue; }
uint32 XWalkGptHostStub::primeCount() const noexcept { return primeCountValue; }
uint32 XWalkGptHostStub::spokenCount() const noexcept { return spokenCountValue; }
uint32 XWalkGptHostStub::stopCount() const noexcept { return stopCountValue; }
} /* namespace xwalk::hal::sim */
