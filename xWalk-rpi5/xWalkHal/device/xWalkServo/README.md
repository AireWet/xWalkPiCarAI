...
cmake --build xWalk-rpi5/xWalkHal/device/xWalkServo/build-host --parallel
ctest --test-dir xWalk-rpi5/xWalkHal/device/xWalkServo/build-host --output-on-failure
```
...
```bash
cmake -S xWalk-rpi5/xWalkHal/device/xWalkServo/simulation -B build-servo-simulation -DCMAKE_BUILD_TYPE=Debug
...
cmake --build xWalk-rpi5/xWalkHal/device/xWalkServo/build-rpi --parallel
ctest --test-dir xWalk-rpi5/xWalkHal/device/xWalkServo/build-rpi -N -L hardware
```
