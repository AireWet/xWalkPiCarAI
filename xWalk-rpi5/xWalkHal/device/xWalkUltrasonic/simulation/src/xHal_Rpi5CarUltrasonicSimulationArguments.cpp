...
{
XWalkUltrasonicSimulationArguments::XWalkUltrasonicSimulationArguments(
...
boolean XWalkUltrasonicSimulationArguments::valid() const noexcept { return validValue; }
boolean XWalkUltrasonicSimulationArguments::helpRequested() const noexcept { return helpRequestedValue; }
