 ...
 */
boolean
XWalkCameraHostStub::capture(contextpointer context, stringview outputPath,
...
const XWalkCameraConfiguration &
XWalkCameraHostStub::configuration() const noexcept {
