...
{
void XWalkUserButtonHostStub::configure(contextpointer context, uint8 pin,
    XWalkGpioMode mode, XWalkGpioPull pull, boolean initialValue)
{
    static_cast<void>(context); static_cast<void>(pin); static_cast<void>(mode);
    static_cast<void>(pull); static_cast<void>(initialValue);
}
...
{
    static_cast<void>(context); static_cast<void>(pin); static_cast<void>(value);
}
void XWalkUserButtonHostStub::interrupt(contextpointer context, uint8 pin,
