 ...
 */
XWalkPwm::XWalkPwm(XWalkI2c &i2c, uint32 channel, optionaluint8 address,
  ...
  XWALK_HAL_TRACE_UID3(
      RPI .159, "PWM channel %u constructed at address 0x%02X with timer %u",
      channelValue, addressValue, timerIndexValue);
}
 ...
 */
XWalkPwm::XWalkPwm(XWalkI2c &i2c, stringview channel, optionaluint8 address,
                   XWalkPwmTimerState &sharedTimerState)
