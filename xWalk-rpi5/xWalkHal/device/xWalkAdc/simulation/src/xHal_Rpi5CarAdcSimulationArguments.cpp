...
{
XWalkAdcSimulationArguments::XWalkAdcSimulationArguments(
...
boolean XWalkAdcSimulationArguments::valid() const noexcept { return validValue; }
boolean XWalkAdcSimulationArguments::helpRequested() const noexcept { return helpRequestedValue; }
