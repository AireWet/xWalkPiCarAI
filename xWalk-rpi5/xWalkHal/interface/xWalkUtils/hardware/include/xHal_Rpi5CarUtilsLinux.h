...
class XWalkUtilsLinux final
{
    protected:
         ...
         */
        static void outputCallback(contextpointer context, XWalkUtilityColor color,
         ...
         */
        static XWalkCommandResult commandCallback(contextpointer context,
    ...
    public:
         ...
         */
        void writeOutput(XWalkUtilityColor color, stringview message,
         ...
         */
        XWalkCommandResult runCommandProcess(stringview command,
