...
```sh
cmake -S xWalk-rpi5/xWalkHal/interface/xWalkUtils/simulation -B xWalk-rpi5/xWalkHal/interface/xWalkUtils/simulation/build-host -DCMAKE_BUILD_TYPE=Debug
cmake --build xWalk-rpi5/xWalkHal/interface/xWalkUtils/simulation/build-host --parallel
xWalk-rpi5/xWalkHal/interface/xWalkUtils/simulation/build-host/xWalkUtilsSimulation --trace RPI.enable
```
...
```sh
cmake -S xWalk-rpi5/xWalkHal/interface/xWalkUtils -B build-utils-linux -DXWALK_UTILS_BUILD_LINUX_BACKEND=ON
