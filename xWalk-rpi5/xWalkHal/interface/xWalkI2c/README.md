...
`xWalk-rpi5/xWalkHal/interface/xWalkI2c/`, while traces from other modules remain disabled.
...
commands from `xWalk-rpi5/xWalkHal/interface/xWalkI2c/simulation`:
...
```bash
cmake -S xWalk-rpi5/xWalkHal/interface/xWalkI2c -B xWalk-rpi5/xWalkHal/interface/xWalkI2c/build-lib -DCMAKE_BUILD_TYPE=Release
