...
cmake --build xWalk-rpi5/xWalkHal/interface/xWalkSpi/build-host --parallel
ctest --test-dir xWalk-rpi5/xWalkHal/interface/xWalkSpi/build-host --output-on-failure
```
...
```bash
cmake -S xWalk-rpi5/xWalkHal/interface/xWalkSpi/simulation -B xWalk-rpi5/xWalkHal/interface/xWalkSpi/simulation/build-simulation -DXWALK_SPI_SIMULATION_BACKEND=stub
cmake --build xWalk-rpi5/xWalkHal/interface/xWalkSpi/simulation/build-simulation --target xWalkSpiSimulation --parallel
...
cmake --build xWalk-rpi5/xWalkHal/interface/xWalkSpi/build-rpi --parallel
ctest --test-dir xWalk-rpi5/xWalkHal/interface/xWalkSpi/build-rpi -N -L hardware
```
