...
and the shared small US English model under the root-level `xWalk-rpi5/xWalkLibrary/common/models`. Override
...
| `TEST_SUITE_XWALK_TRACE` | `xWalk-rpi5/xWalkTrace/test` |
