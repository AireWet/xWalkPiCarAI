...
protected:
    ...
    static void configure(contextpointer context,
    ...
    static string prompt(contextpointer context, stringview model,
        stringview text, stringview imagePath);
...
public:
     ...
     */
    void run(stringview apiKey, XWalkVoiceAssistantExampleInputMode inputMode,
