 ...
 */
void XWalkOpenAiImageExampleLinux::run(stringview apiKey, uint32 maximumPrompts,
    stringview connection, stringview captureExecutable, stringview cameraDevice)
{
    ...
    const XWalkCameraConnection connectionValue =
        XWalkCamera::connectionFromString(connection);
 ...
 */
boolean XWalkOpenAiImageExampleLinux::readPrompt(
