...
XWalkTtsEdgeExampleLinux &
XWalkTtsEdgeExampleLinux::adapter(contextpointer context) {
  if (context == nullptr) {
...
void XWalkTtsEdgeExampleLinux::speak(contextpointer context, stringview voice,
                                     stringview text) {
