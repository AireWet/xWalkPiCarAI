...
`xWalk-rpi5/xWalkHal/xWalkTest/xExample/config/llm-img.jpg` path and submits it as an
...
`xWalk-rpi5/xWalkHal/xWalkTest/xExample/config/llm-img.jpg` path and submits it using Ollama's
...
small US English 0.15 model under the root-level `xWalk-rpi5/xWalkLibrary/common/models`. Set
