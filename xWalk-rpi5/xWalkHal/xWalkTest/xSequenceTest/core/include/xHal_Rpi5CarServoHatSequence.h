 ...
 */
using servohatwaitcallback = void (*)(contextpointer context,
 ...
 */
using servohatadccallback = void (*)(contextpointer context,
...
public:
    ...
    XWalkServoHatSequence(XWalkBoardControl& boardControl,
        const servohatservoarray& servos, const servohatadcarray& adcInputs,
        contextpointer context, servohatwaitcallback wait,
        servohatservocallback reportServo, servohatadccallback reportAdc);
