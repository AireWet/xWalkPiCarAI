...
using motortestwaitcallback = void (*)(contextpointer context,
...
public:
     ...
     * If `wait` is null.
     */
    XWalkMotorSequence(XWalkMotor& firstMotor, XWalkMotor& secondMotor,
        contextpointer context, motortestwaitcallback wait);
