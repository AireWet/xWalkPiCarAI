...
using piperstreamspeakcallback = void (*)(contextpointer context,
    stringview model, stringview text, boolean stream);
 ...
 */
using piperstreammessagecallback = void (*)(contextpointer context,
    stringview message);
 ...
 */
using piperstreamdurationcallback = void (*)(contextpointer context,
...
public:
    ...
    XWalkPiperStreamSequence& operator=(
        const XWalkPiperStreamSequence&) = delete;
