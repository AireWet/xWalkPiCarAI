 ...
 */
int32 XWalkSequenceTestRunner::runButtonEvent(
    int32 argumentCount, char* argumentValues[])
{
    ...
    XWalkGpioLinux backend(
        argumentValues[3U], argumentValues[4U], argumentValues[5U], 18U);
    const XWalkGpioCallbacks callbacks = XHAL_GPIO_CALLBACKS(XWalkGpioLinux);
    XWalkGpio gpio(&backend, callbacks, "D0",
 ...
 */
int32 XWalkSequenceTestRunner::runInitAngles(
    int32 argumentCount, char* argumentValues[])
{
    if (argumentCount != 7)
    {
    ...
    linuxSequence.run(argumentValues[2U], argumentValues[3U],
        argumentValues[4U], argumentValues[5U], argumentValues[6U]);
    return 0;
}
 ...
 * @return Zero after completion, or two for invalid input.
 */
int32 XWalkSequenceTestRunner::runRobotHat5Motor(
    int32 argumentCount, char* argumentValues[])
{
    if (argumentCount != 4)
    {
 ...
 * @return Zero after completion, or two for invalid input.
 */
int32 XWalkSequenceTestRunner::runMotor(
    int32 argumentCount, char* argumentValues[])
{
    if (argumentCount != 7)
    {
    ...
    linuxSequence.run(argumentValues[3U], argumentValues[4U],
        argumentValues[5U], argumentValues[6U], cycleCount);
    return 0;
}
 ...
 * @return Zero after completion, or two for invalid input.
 */
int32 XWalkSequenceTestRunner::runServoHat(
    int32 argumentCount, char* argumentValues[])
{
    if (argumentCount != 7)
    {
    ...
    linuxSequence.run(argumentValues[3U], argumentValues[4U],
        argumentValues[5U], argumentValues[6U], sampleCount);
    return 0;
}
 ...
 * @return Zero after completion, or two for invalid input.
 */
int32 XWalkSequenceTestRunner::runServo(
    int32 argumentCount, char* argumentValues[])
{
    if (argumentCount != 4)
    {
 ...
 * @return Zero after completion, or two for invalid input.
 */
int32 XWalkSequenceTestRunner::runTone(
    int32 argumentCount, char* argumentValues[])
{
    if (argumentCount != 5)
    {
 ...
 * @return Zero after completion, or two for invalid input.
 */
int32 XWalkSequenceTestRunner::runSelection(
    int32 argumentCount, char* argumentValues[])
{
    if (argumentCount < 2)
    {
 ...
 */
int32 XWalkSequenceTestRunner::run(
    int32 argumentCount, char* argumentValues[])
{
