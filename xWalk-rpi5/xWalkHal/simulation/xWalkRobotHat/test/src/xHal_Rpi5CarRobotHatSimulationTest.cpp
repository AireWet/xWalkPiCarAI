...
void testHardwareIndependentComposition()
{
    ...
    xwalk::hal::XWalkI2c i2c(&backend, &XWalkRobotHatSimulation::probe,
        &XWalkRobotHatSimulation::writeRegister, &XWalkRobotHatSimulation::read,
        &XWalkRobotHatSimulation::readRegister, &XWalkRobotHatSimulation::tryWriteRegister);
    ...
    assert(xwalk::hal::test::robothat::countEvents(backend,
        XWalkRobotHatOperation::CameraCapture) == 1U);
...
void testTargetedFailureInjection()
{
    ...
    xwalk::hal::test::expectFailure([]()
    {
        ...
        xwalk::hal::XWalkI2c failingI2c(&failingBackend, &XWalkRobotHatSimulation::probe,
            &XWalkRobotHatSimulation::writeRegister, &XWalkRobotHatSimulation::read,
    ...
    {
        XWalkRobotHatSimulation failingBackend;
        xwalk::hal::XWalkGpio failingGpio(&failingBackend,
            XWalkRobotHatSimulation::gpioCallbacks(), "D4");
    ...
    {
        XWalkRobotHatSimulation failingBackend;
        xwalk::hal::XWalkCamera failingCamera(&failingBackend,
            &XWalkRobotHatSimulation::capture);
