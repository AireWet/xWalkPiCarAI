...
void XWalkMotorHostStub::writeRegister(contextpointer context, uint8 address,
                                       uint8 reg, const bytevector &data) {
  static_cast<void>(address);
  static_cast<void>(reg);
  static_cast<void>(data);
  ++static_cast<XWalkMotorHostStub *>(context)->i2cWriteCountValue;
  XWALK_HAL_TRACE_UID0(RPI .252,
                       "Motor host stub accepted an I2C register write");
}
...
bytevector XWalkMotorHostStub::read(contextpointer context, uint8 address,
                                    size length) {
  static_cast<void>(context);
  static_cast<void>(address);
  return bytevector(length, 0U);
}
void XWalkMotorHostStub::configureGpio(contextpointer context, uint8 pin,
...
void XWalkMotorHostStub::writeGpio(contextpointer context, uint8 pin,
                                   boolean value) {
  static_cast<void>(pin);
  static_cast<XWalkMotorHostStub *>(context)->directionValue = value;
}
void XWalkMotorHostStub::interruptGpio(contextpointer context, uint8 pin,
...
void XWalkMotorHostStub::cancelGpioInterrupt(contextpointer context,
                                             uint8 pin) {
  static_cast<void>(context);
  static_cast<void>(pin);
}
