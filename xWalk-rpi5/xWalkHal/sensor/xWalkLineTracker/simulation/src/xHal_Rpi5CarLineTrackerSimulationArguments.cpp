...
{
XWalkLineTrackerSimulationArguments::XWalkLineTrackerSimulationArguments(
...
boolean XWalkLineTrackerSimulationArguments::valid() const noexcept { return validValue; }
