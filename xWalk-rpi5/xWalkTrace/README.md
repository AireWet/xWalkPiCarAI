...
does not need to be repeated. Example files are in `xWalk-rpi5/xWalkController/xWalkConfig`.
...
<xwalkTraceCatalogue version="1.0" defaultState="disable">
  <module name="RPI" defaultState="disable">
    <trace
      ...
      name="I2C probe"
      sourceFile="xWalk-rpi5/xWalkHal/interface/xWalkI2c/core/src/xHal_Rpi5CarI2c.cpp"
      sourceLine="73"
      priority="2"
...
```bash
cmake -S xWalkTrace -B xWalk-rpi5/xWalkTrace/build-rpi -DXWALK_TRACE_BUILD_HARDWARE_TESTS=ON -DCMAKE_BUILD_TYPE=Debug
