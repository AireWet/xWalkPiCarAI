...
XWalkVideoRecording::XWalkVideoRecording(
...
XWalkVideoRecording::~XWalkVideoRecording() noexcept { stop(); }

void XWalkVideoRecording::validateCallbacks(
    const XWalkVideoRecordingCallbacks &providerCallbacks) {
  if ((providerCallbacks.startCamera == nullptr) ||
      (providerCallbacks.stopCamera == nullptr) ||
      (providerCallbacks.beginRecording == nullptr) ||
      (providerCallbacks.pauseRecording == nullptr) ||
      (providerCallbacks.continueRecording == nullptr) ||
      (providerCallbacks.stopRecording == nullptr) ||
    ...
    XWALK_RPIAGENT_ERROR(XWALK_INVAL,
                         "Video recording requires complete callbacks");
  }
}
