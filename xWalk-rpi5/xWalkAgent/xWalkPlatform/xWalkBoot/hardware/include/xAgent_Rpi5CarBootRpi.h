...
class XWalkBootRpi final : private XWalkBoot
{
    ...
    protected:
        ...
        static void setServoZeroingAngle(agent::contextpointer context,
        ...
        static XWalkComputerVisionColor selectTreasureColor(
        ...
        static agent::uint32 parseUnsigned(agent::stringview value,
        ...
        agent::int32 runDoctor(agent::contextpointer context,
        ...
        agent::int32 runServoZeroing(agent::contextpointer context,
        ...
        agent::int32 runBase(agent::contextpointer context,
        ...
        agent::int32 runLineTracking(agent::contextpointer context,
            bootapplicationcallback callback, XWalkPicarx& picarx);
