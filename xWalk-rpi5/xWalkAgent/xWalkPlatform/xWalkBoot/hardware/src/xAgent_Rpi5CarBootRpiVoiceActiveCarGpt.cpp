 ...
 */
agent::int32 XWalkBootRpi::runVoiceActiveCarGpt(agent::contextpointer context,
...
{
    return runVoiceActiveMode(XWALK_BOOT_VOICE_ACTIVE_CAR_GPT_REQ, context,
        callback, config, boardControl, picarx, gpioDevice, gpioChipName,
        gpioChipLabel, minimumGpioLineCount, gpioCallbacks);
}
