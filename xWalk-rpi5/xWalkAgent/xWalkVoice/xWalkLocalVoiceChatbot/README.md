...
```bash
cmake -S xWalk-rpi5/xWalkAgent/xWalkVoice/xWalkLocalVoiceChatbot -B xWalk-rpi5/xWalkAgent/xWalkVoice/xWalkLocalVoiceChatbot/build-host -DXWALK_LOCAL_VOICE_CHATBOT_BUILD_HOST_TESTS=ON
cmake --build xWalk-rpi5/xWalkAgent/xWalkVoice/xWalkLocalVoiceChatbot/build-host --parallel
ctest --test-dir xWalk-rpi5/xWalkAgent/xWalkVoice/xWalkLocalVoiceChatbot/build-host --output-on-failure
```
