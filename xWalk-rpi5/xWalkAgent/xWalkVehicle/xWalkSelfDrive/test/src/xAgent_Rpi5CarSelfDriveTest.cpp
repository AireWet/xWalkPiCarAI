...
void playSound(agent::contextpointer context, agent::stringview filename,
    agent::optionalfloat64 volume)
{
    static_cast<void>(context);
...
void playSoundBackground(agent::contextpointer context, agent::stringview filename,
    agent::optionalfloat64 volume)
{
...
void playMusic(agent::contextpointer context, agent::stringview filename,
    agent::int32 loops, agent::float64 startSeconds)
{
    static_cast<void>(context);
    static_cast<void>(filename);
...
void playTone(agent::contextpointer context, const agent::bytevector& data,
    agent::uint32 sampleRateHz, agent::uint8 channelCount)
{
    static_cast<void>(context);
    static_cast<void>(data);
...
agent::boolean delayMilliseconds(agent::contextpointer context,
...
void testSelfDriveBehavior(agent::stringview configPath)
{
    ...
    const agent::stringvector gestures{
    ...
    assert(backend.backgroundFiles[0U] ==
        (agent::filesystempath(XWALK_TEST_SOUND_DIRECTORY) /
