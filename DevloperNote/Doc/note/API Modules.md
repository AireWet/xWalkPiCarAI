...
[xWalkLineTracker](../../../xWalkHal/xWalkLineTracker/README.md).

## `XWalkUserButton`

Interprets active-low button events and bounded press timing through a
caller-created GPIO dependency. See [xWalkUserButton](../../../xWalkHal/xWalkUserButton/README.md).
