...
| C++ documentation index | `DevloperNote/index.md` |
| Module API contracts | `xWalkHal/xWalk<Module>/include` |
| Module behavior and tests | `xWalkHal/xWalk<Module>/README.md` |
| Hardware and backends | `DevloperNote/Doc/note/HAL Hardware Architecture.md` |
| CLI composition and plan | `DevloperNote/Doc/note/CLI Architecture.md` |
