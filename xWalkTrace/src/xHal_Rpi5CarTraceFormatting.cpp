...
string XWalkTrace::sanitizedSourceName(stringview sourceFile)
{
    ...
    const string filename = separatorPresent ?
        string(sourceFile.substr(slashPosition + 1U)) : string(sourceFile);
 ...
 */
void XWalkTrace::writeRecordLocked(stringview component, stringview category,
    ...
    stringview message) const
{
    ...
    const std::chrono::system_clock::time_point wallTime =
