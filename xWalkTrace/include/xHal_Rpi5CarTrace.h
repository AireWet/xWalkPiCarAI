...
protected:
  ...
  static XWalkTrace &
  globalInstance(const filesystempath *configurationPath = nullptr,
  ...
  void writeRecordLocked(stringview component, stringview category,
                         stringview uid, stringview sourceFile,
                         uint32 sourceLine, stringview message) const;
  ...
  static string formatMessage(stringview message) { return string(message); }
  ...
  void writeCategory(stringview component, stringview category,
                     stringview selector, stringview sourceFile,
                     uint32 sourceLine, stringview message);
...
public:
   ...
   */
  template <typename... FormatArguments>
  static void globalWriteTagged(stringview component, stringview uid,
                                cstring format, FormatArguments... arguments) {
    globalInstance().writeTagged(component, uid,
                                 formatMessage(format, arguments...));
  }
   ...
   */
  template <typename... FormatArguments>
  static string globalWriteCategory(stringview component, stringview category,
                                    stringview selector, stringview sourceFile,
                                    uint32 sourceLine, cstring format,
                                    FormatArguments... arguments) {
    const string message = formatMessage(format, arguments...);
    globalInstance().writeCategory(component, category, selector, sourceFile,
                                   sourceLine, message);
    return message;
  }
  ...
  do {                                                                         \
    ...
    if (xwalkTraceEnabled) {                                                   \
      xwalk::hal::XWalkTrace::globalWriteTagged(                               \
          COMPONENT, XWALK_STRINGIFY(UID), __VA_ARGS__);                       \
    }                                                                          \
  } while (false)
...
#define XWALK_HAL_TRACE_UID1(UID, FORMAT, ARG1)                                \
  XWALK_TRACE_UID("HAL", UID, FORMAT, ARG1)
#define XWALK_HAL_TRACE_UID2(UID, FORMAT, ARG1, ARG2)                          \
  XWALK_TRACE_UID("HAL", UID, FORMAT, ARG1, ARG2)
#define XWALK_HAL_TRACE_UID3(UID, FORMAT, ARG1, ARG2, ARG3)                    \
  XWALK_TRACE_UID("HAL", UID, FORMAT, ARG1, ARG2, ARG3)
...
#define XWALK_CTRL_TRACE_UID1(UID, FORMAT, ARG1)                               \
  XWALK_TRACE_UID("CTRL", UID, FORMAT, ARG1)
#define XWALK_CTRL_TRACE_UID2(UID, FORMAT, ARG1, ARG2)                         \
  XWALK_TRACE_UID("CTRL", UID, FORMAT, ARG1, ARG2)
#define XWALK_CTRL_TRACE_UID3(UID, FORMAT, ARG1, ARG2, ARG3)                   \
  XWALK_TRACE_UID("CTRL", UID, FORMAT, ARG1, ARG2, ARG3)
 ...
 * count. */
#define XWALK_RPIAGENT_TRACE_UID0(UID, FORMAT)                                 \
  XWALK_TRACE_UID("RPIAGENT", UID, FORMAT)
#define XWALK_RPIAGENT_TRACE_UID1(UID, FORMAT, ARG1)                           \
  XWALK_TRACE_UID("RPIAGENT", UID, FORMAT, ARG1)
#define XWALK_RPIAGENT_TRACE_UID2(UID, FORMAT, ARG1, ARG2)                     \
  XWALK_TRACE_UID("RPIAGENT", UID, FORMAT, ARG1, ARG2)
...
#define XWALK_LIB_TRACE_UID1(UID, FORMAT, ARG1)                                \
  XWALK_TRACE_UID("LIB", UID, FORMAT, ARG1)
#define XWALK_LIB_TRACE_UID2(UID, FORMAT, ARG1, ARG2)                          \
  XWALK_TRACE_UID("LIB", UID, FORMAT, ARG1, ARG2)
#define XWALK_LIB_TRACE_UID3(UID, FORMAT, ARG1, ARG2, ARG3)                    \
  XWALK_TRACE_UID("LIB", UID, FORMAT, ARG1, ARG2, ARG3)
...
#define XWALK_TRACE_CATEGORY(COMPONENT, CATEGORY, SELECTOR, SELECTOR_NAME,     \
  ...
  do {                                                                         \
    ...
    static_cast<void>(xwalk::hal::XWalkTrace::globalWriteCategory(             \
        COMPONENT, CATEGORY, SELECTOR_NAME, __FILE__,                          \
        static_cast<xwalk::hal::uint32>(__LINE__), __VA_ARGS__));              \
  } while (false)

/** @brief Raises one selected C++ exception after its error record is written.
 */
#define XWALK_ERROR_ACTION_XWALK_INVAL(MESSAGE)                                \
  throw xwalk::hal::makeErrorSignal<XWALK_INVAL>(MESSAGE)
#define XWALK_ERROR_ACTION_XWALK_RANGE(MESSAGE)                                \
  throw xwalk::hal::makeErrorSignal<XWALK_RANGE>(MESSAGE)
#define XWALK_ERROR_ACTION_XWALK_LENGTH(MESSAGE)                               \
  throw xwalk::hal::makeErrorSignal<XWALK_LENGTH>(MESSAGE)
#define XWALK_ERROR_ACTION_XWALK_DOMAIN(MESSAGE)                               \
  throw xwalk::hal::makeErrorSignal<XWALK_DOMAIN>(MESSAGE)
#define XWALK_ERROR_ACTION_XWALK_LOGIC(MESSAGE)                                \
  throw xwalk::hal::makeErrorSignal<XWALK_LOGIC>(MESSAGE)
#define XWALK_ERROR_ACTION_XWALK_RUNTIME(MESSAGE)                              \
  throw xwalk::hal::makeErrorSignal<XWALK_RUNTIME>(MESSAGE)
#define XWALK_ERROR_ACTION_XWALK_OVERFLOW(MESSAGE)                             \
  throw xwalk::hal::makeErrorSignal<XWALK_OVERFLOW>(MESSAGE)
#define XWALK_ERROR_ACTION_XWALK_UNDERFLOW(MESSAGE)                            \
  throw xwalk::hal::makeErrorSignal<XWALK_UNDERFLOW>(MESSAGE)
#define XWALK_ERROR_ACTION_XWALK_SYSTEM(MESSAGE)                               \
  throw xwalk::hal::makeErrorSignal<XWALK_SYSTEM>(MESSAGE)
#define XWALK_ERROR_ACTION_XWALK_ALLOC(MESSAGE)                                \
  throw xwalk::hal::makeErrorSignal<XWALK_ALLOC>(MESSAGE)
#define XWALK_ERROR_ACTION_XWALK_CAST(MESSAGE)                                 \
  throw xwalk::hal::makeErrorSignal<XWALK_CAST>(MESSAGE)
#define XWALK_ERROR_ACTION_XWALK_TYPEID(MESSAGE)                               \
  throw xwalk::hal::makeErrorSignal<XWALK_TYPEID>(MESSAGE)
#define XWALK_ERROR_ACTION_XWALK_FUNCTION(MESSAGE)                             \
  throw xwalk::hal::makeErrorSignal<XWALK_FUNCTION>(MESSAGE)
#define XWALK_ERROR_ACTION_XWALK_OPTIONAL(MESSAGE)                             \
  throw xwalk::hal::makeErrorSignal<XWALK_OPTIONAL>(MESSAGE)
#define XWALK_ERROR_ACTION_XWALK_VARIANT(MESSAGE)                              \
  throw xwalk::hal::makeErrorSignal<XWALK_VARIANT>(MESSAGE)
#define XWALK_ERROR_ACTION_XWALK_WEAKPTR(MESSAGE)                              \
  throw xwalk::hal::makeErrorSignal<XWALK_WEAKPTR>(MESSAGE)
...
#define XWALK_TRACE_ERROR(COMPONENT, ACTION, SELECTOR, SELECTOR_NAME, ...)     \
  do {                                                                         \
    static_cast<void>(sizeof(SELECTOR));                                       \
    const xwalk::hal::string xwalkErrorMessage =                               \
        xwalk::hal::XWalkTrace::globalWriteCategory(                           \
            COMPONENT, "ERROR", SELECTOR_NAME, __FILE__,                       \
            static_cast<xwalk::hal::uint32>(__LINE__), __VA_ARGS__);           \
    ACTION(xwalkErrorMessage);                                                 \
  } while (false)

/** @brief Emits one selector-tagged variadic HAL warning. */
#define XWALK_HAL_WARNING(SELECTOR, ...)                                       \
  XWALK_TRACE_CATEGORY("HAL", "WARNING", SELECTOR, #SELECTOR, __VA_ARGS__)
/** @brief Emits one selector-tagged variadic HAL error. */
#define XWALK_HAL_ERROR(SELECTOR, ...)                                         \
  XWALK_TRACE_ERROR("HAL", XWALK_ERROR_ACTION_##SELECTOR, SELECTOR, #SELECTOR, \
                    __VA_ARGS__)
/** @brief Emits one selector-tagged variadic Controller warning. */
#define XWALK_CTRL_WARNING(SELECTOR, ...)                                      \
  XWALK_TRACE_CATEGORY("CTRL", "WARNING", SELECTOR, #SELECTOR, __VA_ARGS__)
/** @brief Emits one selector-tagged variadic Controller error. */
#define XWALK_CTRL_ERROR(SELECTOR, ...)                                        \
  XWALK_TRACE_ERROR("CTRL", XWALK_ERROR_ACTION_##SELECTOR, SELECTOR,           \
...
#define XWALK_RPIAGENT_ERROR(SELECTOR, ...)                                    \
  XWALK_TRACE_ERROR("RPIAGENT", XWALK_ERROR_ACTION_##SELECTOR, SELECTOR,       \
                    #SELECTOR, __VA_ARGS__)
/** @brief Emits one selector-tagged variadic Library warning. */
#define XWALK_LIB_WARNING(SELECTOR, ...)                                       \
  XWALK_TRACE_CATEGORY("LIB", "WARNING", SELECTOR, #SELECTOR, __VA_ARGS__)
/** @brief Emits one selector-tagged variadic Library error. */
#define XWALK_LIB_ERROR(SELECTOR, ...)                                         \
  XWALK_TRACE_ERROR("LIB", XWALK_ERROR_ACTION_##SELECTOR, SELECTOR, #SELECTOR, \
                    __VA_ARGS__)
...
#define XWALK_TRACE_ASSERT(COMPONENT, SIGNAL_NUMBER)                           \
  do {                                                                         \
    ...
    xwalk::hal::XWalkTrace::globalWriteAssertion(                              \
        COMPONENT, static_cast<xwalk::hal::int32>(SIGNAL_NUMBER), __FILE__,    \
 ...
 * signal. */
#define XWALK_CTRL_ASSERT(SIGNAL_NUMBER)                                       \
  XWALK_TRACE_ASSERT("CTRL", SIGNAL_NUMBER)
/** @brief Emits one numeric Agent assertion signal without raising an OS
 * signal. */
#define XWALK_RPIAGENT_ASSERT(SIGNAL_NUMBER)                                   \
  XWALK_TRACE_ASSERT("RPIAGENT", SIGNAL_NUMBER)
