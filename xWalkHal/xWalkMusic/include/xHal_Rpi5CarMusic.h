...
class XWalkMusic
{
    private:
        ...
        musictimesignature timeSignatureValue{
            XHAL_RPI5CAR_MUSIC_DEFAULT_TIME_SIGNATURE_TOP,
        ...
        musictempo tempoValue{
            XHAL_RPI5CAR_MUSIC_DEFAULT_TEMPO_BPM,
            XHAL_RPI5CAR_MUSIC_QUARTER_NOTE};

        /** @brief Duration of one configured tempo beat in seconds. */
        float64 beatUnitSecondsValue{
            XHAL_RPI5CAR_MUSIC_SECONDS_PER_MINUTE /
            XHAL_RPI5CAR_MUSIC_DEFAULT_TEMPO_BPM};
    ...
    public:
         ...
         */
        void setTempo(float64 beatsPerMinute,
            float64 noteValue = XHAL_RPI5CAR_MUSIC_QUARTER_NOTE);
         ...
         */
        void musicPlay(stringview filename, int32 loops = 1, float64 startSeconds = 0.0,
