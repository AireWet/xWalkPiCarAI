...
struct TestBackend
{
    ...
    /** @brief `true` when the most recent PCM open followed a mixer-volume callback. */
...
/** @brief Verifies synchronous callbacks, volume conversion, and PCM byte counts. */
...
/** @brief Verifies streamed loops, pause, resume, stop, and background replacement. */
