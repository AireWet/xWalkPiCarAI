...
cmake --build xWalkHal/layer1/xWalkSpeaker/build-host --parallel
ctest --test-dir xWalkHal/layer1/xWalkSpeaker/build-host --output-on-failure
```
...
cmake --build xWalkHal/layer1/xWalkSpeaker/build-rpi --parallel
ctest --test-dir xWalkHal/layer1/xWalkSpeaker/build-rpi -N -L hardware
```
