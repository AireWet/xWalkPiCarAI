...
```sh
cmake -S xWalkHal/layer1/xWalkVoiceAssistant/simulation -B build/xWalkVoiceAssistant-simulation
...
```sh
cmake -S xWalkHal/layer1/xWalkVoiceAssistant -B build/xWalkVoiceAssistant-rpi -DXWALK_VOICE_ASSISTANT_BUILD_HARDWARE_TESTS=ON
