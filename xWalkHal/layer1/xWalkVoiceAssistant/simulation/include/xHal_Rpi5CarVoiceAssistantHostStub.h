...
{
    private:
        string instructionsValue{}; string promptValue{}; string spokenValue{};
        uint32 listenCountValue{}; uint32 promptCountValue{}; uint32 spokenCountValue{};
        uint32 stopCountValue{}; boolean gpioValue{};
    public:
        ...
        static void registerInterrupt(contextpointer context, uint8 pin, XWalkGpioEdge edge,
