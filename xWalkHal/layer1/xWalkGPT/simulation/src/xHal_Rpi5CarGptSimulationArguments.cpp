...
boolean XWalkGptSimulationArguments::valid() const noexcept { return validValue; }
boolean XWalkGptSimulationArguments::helpRequested() const noexcept { return helpValue; }
