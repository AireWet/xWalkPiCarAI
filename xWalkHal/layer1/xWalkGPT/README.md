...
```bash
cmake -S xWalkHal/layer1/xWalkGPT -B xWalkHal/layer1/xWalkGPT/build-host -DXWALK_GPT_BUILD_HOST_TESTS=ON
cmake --build xWalkHal/layer1/xWalkGPT/build-host --parallel
ctest --test-dir xWalkHal/layer1/xWalkGPT/build-host --output-on-failure
```
...
```bash
cmake -S xWalkHal/layer1/xWalkGPT/simulation -B build/xWalkGPT-simulation
...
```bash
cmake -S xWalkHal/layer1/xWalkGPT -B xWalkHal/layer1/xWalkGPT/build-rpi -DXWALK_GPT_BUILD_HARDWARE_TESTS=ON
cmake --build xWalkHal/layer1/xWalkGPT/build-rpi --parallel
ctest --test-dir xWalkHal/layer1/xWalkGPT/build-rpi -N -L hardware
```
