...
void testValidation() {
  ...
  xwalk::hal::test::expectFailure([&]() {
    ...
    XWalkHal::XWalkRgbLed invalidLed(fixture.red, fixture.green, fixture.blue,
                                     invalidMode);
    static_cast<void>(invalidLed);
  });
  XWalkHal::XWalkRgbLed led(fixture.red, fixture.green, fixture.blue);
  xwalk::hal::test::expectFailure([&]() { led.setColor(0x01'00'00'00U); });
  xwalk::hal::test::expectFailure([&]() { led.setColor("12XZ56"); });
  xwalk::hal::test::expectFailure([&]() { led.setColor("#12345"); });
}
} /* namespace */
/** @brief Runs all host-side RGB LED tests. */
XWalkHal::int32 main() {
  xwalk::hal::XWalkTrace::configureGlobal(
      XWALK_LED_SIMULATION_TRACE_CONFIG_PATH,
