...
cmake --build xWalkHal/sensor/xWalkMotor/build-host --parallel
ctest --test-dir xWalkHal/sensor/xWalkMotor/build-host --output-on-failure
```
...
```bash
cmake -S xWalkHal/sensor/xWalkMotor/simulation -B build-motor-simulation -DCMAKE_BUILD_TYPE=Debug
...
cmake --build xWalkHal/sensor/xWalkMotor/build-rpi --parallel
ctest --test-dir xWalkHal/sensor/xWalkMotor/build-rpi -N -L hardware
```
