 ...
 */
void XWalkLineTracker::setCalibrationData(
 ...
 */
XWalkLineCalibration
XWalkLineTracker::calibrate(const linetrackervalues &lightData,
  ...
  XWALK_HAL_TRACE_UID0(RPI .237,
                       "Line-tracker calibration derived from sensor samples");
  return calibrationValue;
}
 ...
 */
void XWalkLineTracker::updateLineReference(
    const linetrackervalues &currentValues) noexcept {
