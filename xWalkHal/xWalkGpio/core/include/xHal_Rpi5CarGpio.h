 ...
 */
using gpioconfigurecallback = void (*)(contextpointer context, uint8 pin, XWalkGpioMode mode,
 ...
 */
using gpiointerruptcallback = void (*)(contextpointer context, uint8 pin, XWalkGpioEdge edge,
 ...
 * writes as the Python implementation does, applies logical polarity, and manages an optional edge handler.
 */
class XWalkGpio
{
    private:
    ...
    public:
         ...
         */
        XWalkGpio(contextpointer context, const XWalkGpioCallbacks& callbacks, uint32 pin,
            XWalkGpioMode mode = XWalkGpioMode::Output, XWalkGpioPull pull = XWalkGpioPull::None,
         ...
         */
        XWalkGpio(contextpointer context, const XWalkGpioCallbacks& callbacks, stringview pinName,
            XWalkGpioMode mode = XWalkGpioMode::Output, XWalkGpioPull pull = XWalkGpioPull::None,
            boolean activeHigh = true);
         ...
         */
        void irq(contextpointer handlerContext, gpiointerrupthandler handler, XWalkGpioEdge edge,
 ...
 */
#define XHAL_GPIO_CALLBACKS(BACKEND_TYPE) xwalk::hal::XWalkGpioCallbacks{ \
    +[](xwalk::hal::contextpointer context, xwalk::hal::uint8 pin, xwalk::hal::XWalkGpioMode mode, \
        xwalk::hal::XWalkGpioPull pull, xwalk::hal::boolean value) \
    { static_cast<BACKEND_TYPE*>(context)->configurePin(pin, mode, pull, value); }, \
    +[](xwalk::hal::contextpointer context, xwalk::hal::uint8 pin) -> xwalk::hal::boolean \
    { return static_cast<BACKEND_TYPE*>(context)->readPin(pin); }, \
    +[](xwalk::hal::contextpointer context, xwalk::hal::uint8 pin, xwalk::hal::boolean value) \
    { static_cast<BACKEND_TYPE*>(context)->writePin(pin, value); }, \
    +[](xwalk::hal::contextpointer context, xwalk::hal::uint8 pin, xwalk::hal::XWalkGpioEdge edge, \
        xwalk::hal::uint32 debounceMs, xwalk::hal::contextpointer handlerContext, \
        xwalk::hal::gpiointerrupthandler handler) \
    { \
        static_cast<BACKEND_TYPE*>(context)->registerInterrupt( \
            pin, edge, debounceMs, handlerContext, handler); \
    }, \
    +[](xwalk::hal::contextpointer context, xwalk::hal::uint8 pin) \
    { static_cast<BACKEND_TYPE*>(context)->cancelInterrupt(pin); }}
