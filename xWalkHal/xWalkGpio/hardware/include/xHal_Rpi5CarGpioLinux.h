...
class XWalkGpioLinux
{
    ...
    protected:
         ...
         */
        static int32 openDevice(cstring devicePath, stringview expectedName,
    ...
    public:
        ...
        explicit XWalkGpioLinux(cstring devicePath = XHAL_RPI5CAR_GPIO_DEFAULT_DEVICE,
            stringview expectedName = {}, stringview expectedLabel = {},
         ...
         */
        void registerInterrupt(uint8 pin, XWalkGpioEdge edge, uint32 debounceMs,
