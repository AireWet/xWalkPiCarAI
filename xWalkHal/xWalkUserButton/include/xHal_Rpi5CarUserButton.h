...
class XWalkUserButton
{
    private:
        ...
        float64 longPressDurationSecondsValue{
            XHAL_RPI5CAR_USER_BUTTON_DEFAULT_LONG_PRESS_SECONDS};
    ...
    public:
         ...
         */
        void setOnLongPress(contextpointer context, userbuttoncallback callback,
         ...
         * If `durationSeconds` is not finite.
         */
        void setOnLongPressReleased(contextpointer context, userbuttoncallback callback,
            float64 durationSeconds = XHAL_RPI5CAR_USER_BUTTON_DEFAULT_LONG_PRESS_SECONDS);
