 ...
 */
void XWalkUserButton::setOnPressReleased(
    contextpointer context, userbuttonstatecallback callback)
{
    const mutexlock lock(stateMutex);
 ...
 */
void XWalkUserButton::setOnLongPress(contextpointer context, userbuttoncallback callback,
...
void XWalkUserButton::setOnLongPressReleased(contextpointer context,
    userbuttoncallback callback, float64 durationSeconds)
{
    const float64 validatedDuration = validatedLongPressDuration(durationSeconds);
    const mutexlock lock(stateMutex);
...
void XWalkUserButton::handlePress()
{
    ...
    contextpointer selectedStateContext = nullptr;
    {
        ...
        const float64 durationMicroseconds = longPressDurationSecondsValue *
