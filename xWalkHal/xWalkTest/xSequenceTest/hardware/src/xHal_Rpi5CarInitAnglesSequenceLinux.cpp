...
void XWalkInitAnglesSequenceLinux::run(cstring i2cDevice, cstring gpioDevice,
    cstring gpioChipName, cstring gpioChipLabel, stringview configurationPath)
{
    ...
    XWalkInitAnglesSequence sequence(boardControl, robot,
