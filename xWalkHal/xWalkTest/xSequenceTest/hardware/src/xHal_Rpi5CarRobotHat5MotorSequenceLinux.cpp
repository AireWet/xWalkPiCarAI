...
void XWalkRobotHat5MotorSequenceLinux::run(
    cstring i2cDevice, uint32 cycleCount)
{
    ...
    XWalkRobotHat5MotorSequence sequence(firstMotor, secondMotor,
        thirdMotor, fourthMotor, this, &XWalkRobotHat5MotorSequenceLinux::wait);
    sequence.run(cycleCount);
}

void XWalkRobotHat5MotorSequenceLinux::wait(
