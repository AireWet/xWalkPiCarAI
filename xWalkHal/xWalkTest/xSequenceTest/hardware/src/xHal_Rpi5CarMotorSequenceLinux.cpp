...
void XWalkMotorSequenceLinux::run(cstring i2cDevice, cstring gpioDevice,
    stringview chipName, stringview chipLabel, uint32 cycleCount)
{
    ...
    XWalkI2c i2c(&i2cBackend, XHAL_I2C_PROBE_CALLBACK(XWalkI2cLinux),
        ...
        XHAL_I2C_READ_CALLBACK(XWalkI2cLinux), nullptr,
    ...
    XWalkMotorSequence sequence(firstMotor, secondMotor,
        this, &XWalkMotorSequenceLinux::wait);
    sequence.run(cycleCount);
}

void XWalkMotorSequenceLinux::wait(
