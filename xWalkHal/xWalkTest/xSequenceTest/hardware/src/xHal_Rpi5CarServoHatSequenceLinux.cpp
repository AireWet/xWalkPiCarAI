 ...
 */
void unusedSpeakerPrime(XWalkHal::contextpointer context,
...
void XWalkServoHatSequenceLinux::run(cstring i2cDevice, cstring gpioDevice,
  ...
  XWalkBoardControl boardControl(resetGpio, speakerGpio, adc4, nullptr,
                                 &unusedSpeakerPrime);
  ...
  const servohatservoarray servos{{&servo0, &servo1, &servo2, &servo3, &servo4,
                                   &servo5, &servo6, &servo7, &servo8, &servo9,
                                   &servo10, &servo11, &servo12, &servo13,
                                   &servo14, &servo15}};
 ...
 */
void XWalkServoHatSequenceLinux::wait(contextpointer context,
 ...
 */
void XWalkServoHatSequenceLinux::reportServo(contextpointer context,
                                             uint8 channel) {
  static_cast<void>(context);
  XWALK_HAL_TRACE_UID1(RPI .388, "Servo channel %u set to zero degrees",
 ...
 */
void XWalkServoHatSequenceLinux::reportAdc(contextpointer context,
                                           const servohatreadings &readings) {
  static_cast<void>(context);
  XWALK_HAL_TRACE_UID5(
      RPI .389, "Servo HAT ADC sample: %u %u %u %u %u",
      static_cast<uint32>(readings[0U]), static_cast<uint32>(readings[1U]),
      static_cast<uint32>(readings[2U]), static_cast<uint32>(readings[3U]),
