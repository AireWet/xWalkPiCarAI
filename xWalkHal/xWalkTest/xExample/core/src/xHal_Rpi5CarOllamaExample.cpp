    ...
    callbacks(consoleCallbacks)
{
    ...
    {
        XHAL_THROW_INVALID_ARGUMENT("Ollama example requires complete console callbacks");
    }
}
...
void XWalkOllamaExample::run(uint32 maximumPrompts)
{
    ...
    {
        XHAL_THROW_OUT_OF_RANGE("Ollama example prompt count is outside its range");
    }
