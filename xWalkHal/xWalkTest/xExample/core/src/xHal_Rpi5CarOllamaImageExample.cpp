    ...
    consoleContext(context), callbacks(consoleCallbacks)
{
    ...
    {
        XHAL_THROW_INVALID_ARGUMENT("Ollama image example requires complete console callbacks");
    }
}
...
void XWalkOllamaImageExample::run(uint32 maximumPrompts, stringview imagePath)
{
    ...
    {
        XHAL_THROW_OUT_OF_RANGE("Ollama image example prompt count is outside its range");
    }
