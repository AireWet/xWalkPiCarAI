...
{
    static_cast<OllamaExampleState*>(context)->instructions =
        XWalkHal::string(instructions);
}
...
void testConversation()
{
    ...
    xwalk::hal::example::XWalkOllamaExample example(
...
void testValidation()
{
    OllamaExampleState state;
    XWalkHal::XWalkLanguageModel model(&state, modelCallbacks());
    xwalk::hal::example::XWalkOllamaExampleCallbacks incompleteCallbacks =
        consoleCallbacks();
    incompleteCallbacks.write = nullptr;
    XWalkHal::boolean rejectedCallbacks = false;
    try
    {
        xwalk::hal::example::XWalkOllamaExample invalidExample(
