...
{
    static_cast<OpenAiExampleState*>(context)->instructions =
        XWalkHal::string(instructions);
}
...
void testConversation()
{
    ...
    xwalk::hal::example::XWalkOpenAiExample example(
...
void testValidation()
{
    OpenAiExampleState state;
    XWalkHal::XWalkLanguageModel model(&state, modelCallbacks());
    xwalk::hal::example::XWalkOpenAiExampleCallbacks incompleteCallbacks =
        consoleCallbacks();
    incompleteCallbacks.write = nullptr;
    XWalkHal::boolean rejectedCallbacks = false;
    try
    {
        xwalk::hal::example::XWalkOpenAiExample invalidExample(
