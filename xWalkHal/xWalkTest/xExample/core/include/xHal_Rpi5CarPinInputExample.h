...
using pininputexamplewaitcallback = void (*)(contextpointer context,
    uint32 durationMilliseconds);

/** @brief Reports one source-compatible logical pin value. */
using pininputexamplereportcallback = void (*)(contextpointer context,
    boolean value);
...
public:
     ...
     */
    XWalkPinInputExample(contextpointer context,
