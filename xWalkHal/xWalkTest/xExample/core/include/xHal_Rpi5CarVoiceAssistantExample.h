...
using voiceassistantexampleconfigurecallback = void (*)(contextpointer context,
    const XWalkVoiceAssistantExampleConfiguration& configuration);
using voiceassistantexamplereadcallback = boolean (*)(contextpointer context,
    string& inputText);
using voiceassistantexamplelistencallback = string (*)(contextpointer context,
    uint32 timeoutMs, stringview language);
using voiceassistantexamplecapturecallback = boolean (*)(contextpointer context,
...
using voiceassistantexamplespeakcallback = void (*)(contextpointer context,
    stringview model, stringview text);
using voiceassistantexamplereportcallback = void (*)(contextpointer context,
    stringview text);
...
protected:
    ...
    boolean acquirePrompt(XWalkVoiceAssistantExampleInputMode inputMode,
        uint32 timeoutMs, string& promptText);
...
public:
    ...
    XWalkVoiceAssistantExample& operator=(
        const XWalkVoiceAssistantExample&) = delete;
    ...
    void run(XWalkVoiceAssistantExampleInputMode inputMode,
        uint32 maximumRounds, uint32 timeoutMs, stringview imagePath);
};
