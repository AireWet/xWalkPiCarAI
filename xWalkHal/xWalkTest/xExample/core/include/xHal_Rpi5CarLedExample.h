...
using ledexampleblinkcallback = void (*)(contextpointer context,
    uint32 cycleCount, float64 toggleDelaySeconds, float64 pauseSeconds);
 ...
 */
using ledexamplewaitcallback = void (*)(contextpointer context,
...
public:
     ...
     */
    XWalkLedExample(contextpointer context,
