 ...
 */
using doubaoimagereadcallback = boolean (*)(contextpointer context,
    string& inputText);
...
public:
     ...
     */
    XWalkDoubaoImageExample(XWalkCamera& camera, XWalkLanguageModel& languageModel,
        contextpointer context, const XWalkDoubaoImageExampleCallbacks& consoleCallbacks);
