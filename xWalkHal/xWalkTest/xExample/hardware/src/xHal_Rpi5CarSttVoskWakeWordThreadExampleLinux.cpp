...
void XWalkSttVoskWakeWordThreadExampleLinux::run(uint32 detectionCount,
    uint32 maximumPolls, uint32 listenTimeoutMs, stringview microphoneDevice,
...
void XWalkSttVoskWakeWordThreadExampleLinux::wait(
...
void XWalkSttVoskWakeWordThreadExampleLinux::report(
