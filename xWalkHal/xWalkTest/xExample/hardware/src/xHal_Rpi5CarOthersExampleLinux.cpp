 ...
 */
void XWalkOthersExampleLinux::run(stringview apiKey, stringview endpoint,
    stringview model, uint32 maximumPrompts)
{
 ...
 */
boolean XWalkOthersExampleLinux::readPrompt(
 ...
 */
void XWalkOthersExampleLinux::write(contextpointer context, stringview text,
