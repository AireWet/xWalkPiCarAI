...
public:
     ...
     */
    XWalkTtsPiperExampleLinux(stringview synthesisExecutable,
    ...
    XWalkTtsPiperExampleLinux(
        const XWalkTtsPiperExampleLinux&) = delete;
    XWalkTtsPiperExampleLinux(XWalkTtsPiperExampleLinux&&) = delete;
    XWalkTtsPiperExampleLinux& operator=(
        const XWalkTtsPiperExampleLinux&) = delete;
    XWalkTtsPiperExampleLinux& operator=(
        XWalkTtsPiperExampleLinux&&) = delete;
