...
public:
    ...
    XWalkSttVoskWakeWordThreadExampleLinux(
        const XWalkSttVoskWakeWordThreadExampleLinux&) = delete;
    XWalkSttVoskWakeWordThreadExampleLinux(
        XWalkSttVoskWakeWordThreadExampleLinux&&) = delete;
    XWalkSttVoskWakeWordThreadExampleLinux& operator=(
        const XWalkSttVoskWakeWordThreadExampleLinux&) = delete;
    XWalkSttVoskWakeWordThreadExampleLinux& operator=(
        XWalkSttVoskWakeWordThreadExampleLinux&&) = delete;
     ...
     */
    void run(uint32 detectionCount, uint32 maximumPolls, uint32 listenTimeoutMs,
