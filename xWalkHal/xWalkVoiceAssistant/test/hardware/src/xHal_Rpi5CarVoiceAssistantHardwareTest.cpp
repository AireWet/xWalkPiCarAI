...
/** @brief Contains explicit provider state and non-physical board-control seams. */
namespace
{
...
/** @brief Accepts speaker priming because power is deployment-owned in this smoke test. */
    ...
    XWalkHal::contextpointer context, XWalkHal::stringview text)
{
    ...
    {
        pcmData.push_back(static_cast<XWalkHal::uint8>(
    ...
    XWalkHal::charpointer argumentValues[])
{
    ...
    XWalkHal::XWalkGpio speakerGpio(&providers, gpioCallbacks,
    ...
    XWalkHal::XWalkSpeechToTextAlsa speechBackend(argumentValues[1],
        &providers, recognizerOperations);
    ...
    XWalkHal::XWalkTextToSpeech textToSpeech(boardControl,
        &speechOutputBackend, speechOutputBackend.callback());
    XWalkHal::XWalkVoiceAssistant assistant(speechToText, languageModel,
        textToSpeech, {"Answer briefly.", {}});
