...
class XWalkRobotHatSimulation final
{
    private:
        ...
        void record(XWalkRobotHatOperation operation, uint32 target, uint32 value,
            boolean succeeded, const bytevector& data = {}, stringview text = {});
    ...
    public:
        ...
        static boolean tryWriteRegister(contextpointer context, uint8 address, uint8 reg,
