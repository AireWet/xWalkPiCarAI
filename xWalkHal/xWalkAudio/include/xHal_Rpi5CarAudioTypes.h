 ...
 */
using audiowritepcmcallback = int32 (*)(contextpointer context, audiopcmhandle pcmHandle,
 ...
 */
using audiorecoverpcmcallback = boolean (*)(contextpointer context,
 ...
 */
using audioopenmixercallback = audiomixerhandle (*)(contextpointer context,
 ...
 * Non-null backend-owned handle that becomes invalid after this call.
 */
using audioclosemixercallback = void (*)(contextpointer context,
