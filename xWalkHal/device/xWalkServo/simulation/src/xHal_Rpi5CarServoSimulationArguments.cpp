...
{
XWalkServoSimulationArguments::XWalkServoSimulationArguments(
...
boolean XWalkServoSimulationArguments::valid() const noexcept { return validValue; }
boolean XWalkServoSimulationArguments::helpRequested() const noexcept { return helpRequestedValue; }
