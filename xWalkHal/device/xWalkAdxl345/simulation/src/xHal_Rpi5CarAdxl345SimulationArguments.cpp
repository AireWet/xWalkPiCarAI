...
{
XWalkAdxl345SimulationArguments::XWalkAdxl345SimulationArguments(
...
boolean XWalkAdxl345SimulationArguments::valid() const noexcept { return validValue; }
boolean XWalkAdxl345SimulationArguments::helpRequested() const noexcept { return helpRequestedValue; }
