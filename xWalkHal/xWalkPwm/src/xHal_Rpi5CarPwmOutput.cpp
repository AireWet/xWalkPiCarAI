...
void XWalkPwm::setPulseWidth(float64 pulseWidth)
{
    ...
    {
        XHAL_THROW_OUT_OF_RANGE("pulse width must be in range 0..65535");
    }
...
void XWalkPwm::setPulseWidthPercent(float64 percent)
{
    ...
    {
        XHAL_THROW_OUT_OF_RANGE("pulse width percent must be in range 0..100");
    }
...
void XWalkPwm::write16(uint8 reg, uint32 value)
{
    ...
    {
        XHAL_THROW_OUT_OF_RANGE("PWM value exceeds 16 bits");
    }
