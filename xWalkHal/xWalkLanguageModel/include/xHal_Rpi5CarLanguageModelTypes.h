 ...
 */
using languagemodelmessagecallback = void (*)(contextpointer context, XWalkLanguageModelRole role,
 ...
 */
using languagemodelpromptcallback = string (*)(contextpointer context, stringview promptText,
