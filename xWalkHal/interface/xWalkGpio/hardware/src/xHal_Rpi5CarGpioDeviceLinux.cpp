...
boolean XWalkGpioDeviceLinux::readChipInformation(
    int32 chipDescriptor, contextpointer information)
{
...
int32 XWalkGpioDeviceLinux::readEvent(
    int32 lineDescriptor, contextpointer eventData, size length)
{
