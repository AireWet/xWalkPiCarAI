...
#define XHAL_GPIO_CALLBACKS(BACKEND_TYPE) xwalk::hal::XWalkGpioCallbacks{ \
    +[](xwalk::hal::contextpointer xwalkCallbackContext, xwalk::hal::uint8 xwalkCallbackPin, \
        xwalk::hal::XWalkGpioMode xwalkCallbackMode, xwalk::hal::XWalkGpioPull xwalkCallbackPull, \
        xwalk::hal::boolean xwalkCallbackValue) \
    { static_cast<BACKEND_TYPE*>(xwalkCallbackContext)->configurePin( \
        xwalkCallbackPin, xwalkCallbackMode, xwalkCallbackPull, xwalkCallbackValue); }, \
    +[](xwalk::hal::contextpointer xwalkCallbackContext, xwalk::hal::uint8 xwalkCallbackPin) \
        -> xwalk::hal::boolean \
    { return static_cast<BACKEND_TYPE*>(xwalkCallbackContext)->readPin(xwalkCallbackPin); }, \
    +[](xwalk::hal::contextpointer xwalkCallbackContext, xwalk::hal::uint8 xwalkCallbackPin, \
        xwalk::hal::boolean xwalkCallbackValue) \
    { static_cast<BACKEND_TYPE*>(xwalkCallbackContext)->writePin( \
        xwalkCallbackPin, xwalkCallbackValue); }, \
    +[](xwalk::hal::contextpointer xwalkCallbackContext, xwalk::hal::uint8 xwalkCallbackPin, \
        xwalk::hal::XWalkGpioEdge xwalkCallbackEdge, xwalk::hal::uint32 xwalkCallbackDebounceMs, \
        xwalk::hal::contextpointer xwalkCallbackHandlerContext, \
        xwalk::hal::gpiointerrupthandler xwalkCallbackHandler) \
    { \
        static_cast<BACKEND_TYPE*>(xwalkCallbackContext)->registerInterrupt( \
            xwalkCallbackPin, xwalkCallbackEdge, xwalkCallbackDebounceMs, \
            xwalkCallbackHandlerContext, xwalkCallbackHandler); \
    }, \
    +[](xwalk::hal::contextpointer xwalkCallbackContext, xwalk::hal::uint8 xwalkCallbackPin) \
