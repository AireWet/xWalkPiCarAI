...
class XWalkLanguageModelOllama final
{
    private:
        ...
        uint32 maximumOutputTokensValue{
    ...
    protected:
         ...
         */
        static string systemPostJson(contextpointer context, stringview endpoint,
            stringview requestJson, stringview authorizationHeader,
         ...
         */
        static size systemWriteResponse(charpointer data, size itemSize,
            size itemCount, contextpointer userData);
         ...
         */
        static void validateConstruction(
         ...
         */
        static string prompt(contextpointer context, stringview promptText,
         ...
         * @throws std::out_of_range If serialization exceeds the request limit.
         */
        void appendMessageJson(string& output,
    ...
    public:
         ...
         * @throws std::out_of_range If a text or timeout limit is exceeded.
         */
        XWalkLanguageModelOllama(stringview endpoint, stringview model,
         ...
         * @param[in] maximumOutputTokens Non-zero bounded compatible completion limit.
         */
        XWalkLanguageModelOllama(XWalkLanguageModelHttpDialect dialect,
            stringview endpoint, stringview model, stringview apiKey,
            uint32 timeoutMs = XHAL_RPI5CAR_LANGUAGE_MODEL_OLLAMA_DEFAULT_TIMEOUT_MS,
        ...
        XWalkLanguageModelOllama(contextpointer context,
            ...
            stringview model, stringview apiKey,
            uint32 timeoutMs = XHAL_RPI5CAR_LANGUAGE_MODEL_OLLAMA_DEFAULT_TIMEOUT_MS,
            uint32 maximumOutputTokens =
                XHAL_RPI5CAR_LANGUAGE_MODEL_HTTP_DEFAULT_MAXIMUM_OUTPUT_TOKENS);
