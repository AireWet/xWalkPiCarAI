...
XWalkLanguageModelHostStub::~XWalkLanguageModelHostStub() = default;
void XWalkLanguageModelHostStub::setInstructions(contextpointer context,
                                                 stringview instructions) {
  static_cast<XWalkLanguageModelHostStub *>(context)->instructionsValue =
      string(instructions);
}
void XWalkLanguageModelHostStub::setWelcome(contextpointer context,
                                            stringview welcome) {
  static_cast<XWalkLanguageModelHostStub *>(context)->welcomeValue =
      string(welcome);
}
void XWalkLanguageModelHostStub::setMaximumMessages(contextpointer context,
                                                    uint32 maximumMessages) {
  static_cast<XWalkLanguageModelHostStub *>(context)->maximumMessagesValue =
      maximumMessages;
}
...
string XWalkLanguageModelHostStub::prompt(contextpointer context,
  ...
  XWALK_HAL_TRACE_UID0(
      RPI .149, "Host language-model prompt mirrored without network access");
...
string XWalkLanguageModelHostStub::promptText() const { return promptValue; }
