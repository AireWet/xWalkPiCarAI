 ...
 */
XWalkConfigSimulationArguments::XWalkConfigSimulationArguments(
 ...
 */
boolean XWalkConfigSimulationArguments::valid() const noexcept { return validValue; }

/**
 * @brief Returns whether help was requested.
 * @return `true` for `--help` or `-h`; otherwise `false`.
 */
boolean XWalkConfigSimulationArguments::helpRequested() const noexcept { return helpRequestedValue; }
