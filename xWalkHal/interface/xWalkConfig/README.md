...
```bash
cmake -S xWalkHal/interface/xWalkConfig/simulation -B xWalkHal/interface/xWalkConfig/simulation/build-host -DCMAKE_BUILD_TYPE=Debug
cmake --build xWalkHal/interface/xWalkConfig/simulation/build-host --parallel
xWalkHal/interface/xWalkConfig/simulation/build-host/xWalkConfigSimulation --trace RPI.enable
```
