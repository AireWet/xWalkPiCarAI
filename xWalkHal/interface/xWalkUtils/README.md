...
```sh
cmake -S xWalkHal/interface/xWalkUtils/simulation -B xWalkHal/interface/xWalkUtils/simulation/build-host -DCMAKE_BUILD_TYPE=Debug
cmake --build xWalkHal/interface/xWalkUtils/simulation/build-host --parallel
xWalkHal/interface/xWalkUtils/simulation/build-host/xWalkUtilsSimulation --trace RPI.enable
```
...
```sh
cmake -S xWalkHal/interface/xWalkUtils -B build-utils-linux -DXWALK_UTILS_BUILD_LINUX_BACKEND=ON
