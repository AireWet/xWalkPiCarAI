...
{
XWalkUtilsSimulationArguments::XWalkUtilsSimulationArguments(
    ...
    validValue(false), helpRequestedValue(false)
{
    ...
    const boolean singleOption = (argumentCount == 2) && (argumentValues != nullptr) &&
...
boolean XWalkUtilsSimulationArguments::valid() const noexcept { return validValue; }
boolean XWalkUtilsSimulationArguments::helpRequested() const noexcept { return helpRequestedValue; }
