...
`xWalkHal/interface/xWalkI2c/`, while traces from other modules remain disabled.
...
commands from `xWalkHal/interface/xWalkI2c/simulation`:
...
```bash
cmake -S xWalkHal/interface/xWalkI2c -B xWalkHal/interface/xWalkI2c/build-lib -DCMAKE_BUILD_TYPE=Release
