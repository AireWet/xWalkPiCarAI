...
class XWalkAudioAlsa final
{
    private:
        ...
        fixedarray<XWalkAudioStreamConfiguration,
            XHAL_RPI5CAR_AUDIO_MAXIMUM_STREAM_COUNT> streamConfigurations{};
    ...
    protected:
         ...
         */
        static XWalkAudioStreamConfiguration validateConfiguration(
        ...
        static boolean systemConfigurePcm(contextpointer context, audiopcmhandle pcmHandle,
            const XWalkAudioStreamConfiguration& configuration);
        /** @brief Writes frames to one real ALSA PCM playback handle. */
        static int32 systemWritePcm(contextpointer context, audiopcmhandle pcmHandle,
            const bytevector& pcmData, size byteOffset, size frameCount);
        /** @brief Recovers one real ALSA PCM playback handle. */
        static boolean systemRecoverPcm(contextpointer context,
    ...
    public:
        ...
        explicit XWalkAudioAlsa(stringview pcmDeviceName = "default",
            stringview mixerDeviceName = "default", stringview mixerElementName = "PCM");
         ...
         */
        void writeFrames(audiopcmhandle streamHandle, const bytevector& pcmData,
            size frameCount);
