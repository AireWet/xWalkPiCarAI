...
```bash
cmake -S xWalkHal/interface/xWalkAudio -B xWalkHal/interface/xWalkAudio/build-host -DXWALK_AUDIO_BUILD_HOST_TESTS=ON
cmake --build xWalkHal/interface/xWalkAudio/build-host --parallel
ctest --test-dir xWalkHal/interface/xWalkAudio/build-host --output-on-failure
```
...
```bash
cmake -S xWalkHal/interface/xWalkAudio/simulation -B xWalkHal/interface/xWalkAudio/simulation/build-stub -DCMAKE_BUILD_TYPE=Debug
cmake --build xWalkHal/interface/xWalkAudio/simulation/build-stub --parallel
xWalkHal/interface/xWalkAudio/simulation/build-stub/xWalkAudioSimulation --trace RPI.enable
```
...
```bash
cmake -S xWalkHal/interface/xWalkAudio -B xWalkHal/interface/xWalkAudio/build-linux -DXWALK_AUDIO_BUILD_LINUX_BACKEND=ON
cmake --build xWalkHal/interface/xWalkAudio/build-linux --parallel
```

## Raspberry Pi hardware test

```bash
cmake -S xWalkHal/interface/xWalkAudio -B xWalkHal/interface/xWalkAudio/build-rpi -DXWALK_AUDIO_BUILD_HARDWARE_TESTS=ON
cmake --build xWalkHal/interface/xWalkAudio/build-rpi --parallel
ctest --test-dir xWalkHal/interface/xWalkAudio/build-rpi -N -L hardware
```
