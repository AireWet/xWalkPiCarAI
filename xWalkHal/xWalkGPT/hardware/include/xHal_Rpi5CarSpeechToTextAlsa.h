...
class XWalkSpeechToTextAlsa final
{
    ...
    protected:
         ...
         */
        static XWalkSpeechToTextAlsaOperations systemCaptureOperations(
         ...
         */
        static speechcapturehandle systemOpenCapture(contextpointer context, stringview deviceName,
            uint32 sampleRateHz, uint8 channelCount, uint32 periodFrames);
         ...
         */
        static int32 systemReadCapture(contextpointer context, speechcapturehandle captureHandle,
            bytevector& pcmData, size frameCount);
         ...
         */
        static boolean systemRecoverCapture(contextpointer context,
         ...
         */
        static void systemCloseCapture(contextpointer context,
    ...
    public:
         ...
         */
        XWalkSpeechToTextAlsa(stringview deviceName, contextpointer recognizerContext,
            const XWalkSpeechToTextAlsaOperations& recognizerOperations);
