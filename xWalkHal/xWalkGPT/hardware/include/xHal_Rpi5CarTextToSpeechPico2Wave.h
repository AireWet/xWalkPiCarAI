...
class XWalkTextToSpeechPico2Wave final
{
    ...
    public:
         ...
         */
        XWalkTextToSpeechPico2Wave(stringview executable,
            stringview playbackExecutable, stringview language);
        ...
        XWalkTextToSpeechPico2Wave& operator=(
            const XWalkTextToSpeechPico2Wave&) = delete;
