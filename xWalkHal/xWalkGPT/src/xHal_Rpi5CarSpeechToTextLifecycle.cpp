...
void XWalkSpeechToText::validateCallbacks(const XWalkSpeechToTextCallbacks& backendCallbacks)
{
    ...
    {
        XHAL_THROW_INVALID_ARGUMENT("Speech-to-text backend requires every callback");
    }
}
...
void XWalkSpeechToText::validateTimeout(uint32 timeoutMs)
{
    ...
    {
        XHAL_THROW_OUT_OF_RANGE("Speech-to-text timeout is outside its supported range");
    }
}
 ...
 */
XWalkSpeechToText::XWalkSpeechToText(contextpointer context,
