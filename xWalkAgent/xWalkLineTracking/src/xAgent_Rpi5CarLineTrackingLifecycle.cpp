 ...
 */
XWalkLineTracking::XWalkLineTracking(XWalkPicarx& picarx, hal::contextpointer context,
    ...
    linetrackingdelaycallback callback)
{
    ...
    if ((!XHAL_IS_FINITE(configuration.powerPercent)) ||
 ...
 */
void XWalkLineTracking::delay(hal::uint32 durationMs) const
{
