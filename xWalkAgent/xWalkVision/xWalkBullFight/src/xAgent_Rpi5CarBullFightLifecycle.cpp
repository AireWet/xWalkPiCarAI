    ...
    const XWalkBullFightConfiguration& configuration)
{
    ...
    {
        XHAL_THROW_INVALID_ARGUMENT("Bull fight requires complete callbacks");
    }
    ...
    {
        XHAL_THROW_INVALID_ARGUMENT("Bull-fight numeric settings must be finite");
    }
    ...
    {
        XHAL_THROW_OUT_OF_RANGE("Bull-fight configuration is out of range");
    }
}
