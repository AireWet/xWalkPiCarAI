...
using computervisioncolorcallback = void (*)(agent::contextpointer context,
    XWalkComputerVisionColor color);
/** @brief Enables or disables one binary detector. */
using computervisionswitchcallback = void (*)(agent::contextpointer context,
    agent::boolean enabled);
/** @brief Samples current detection results from one camera frame. */
using computervisionobservecallback = XWalkComputerVisionObservation (*)(
    agent::contextpointer context);
/** @brief Suspends execution for a bounded interval. */
using computervisiondelaycallback = void (*)(agent::contextpointer context,
