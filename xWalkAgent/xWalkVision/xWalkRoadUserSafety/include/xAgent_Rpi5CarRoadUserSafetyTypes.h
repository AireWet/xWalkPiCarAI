...
using roaduserdetectcallback = XWalkRoadUserDetectionBatch (*)(
    agent::contextpointer context) noexcept;
/** @brief Classifies one validated road-user feature vector. */
using roaduserriskclassifycallback = XWalkRoadRiskClassification (*)(
    agent::contextpointer context, const XWalkRoadRiskFeatures& features) noexcept;
...
using roaduseralertcallback = void (*)(agent::contextpointer context,
    XWalkRoadRisk risk, agent::uint32 detectionCount) noexcept;
...
using roaduserfaultcallback = void (*)(agent::contextpointer context,
