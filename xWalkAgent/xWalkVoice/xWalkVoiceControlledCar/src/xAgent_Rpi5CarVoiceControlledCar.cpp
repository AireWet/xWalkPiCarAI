...
XWalkVoiceControlledCarCommand XWalkVoiceControlledCar::classifyCommand(
    agent::stringview transcript, agent::stringview sleepWord)
{
    ...
    const agent::boolean normalizedNormalizeSleepWordDifferent =
        static_cast<agent::boolean>(
            normalized.find(normalize(sleepWord)) != agent::string::npos);
    ...
    const agent::boolean normalizedBackwardDifferent =
        static_cast<agent::boolean>(
            normalized.find("backward") != agent::string::npos);
...
agent::boolean XWalkVoiceControlledCar::containsWakeWord(
    agent::stringview transcript, agent::stringview wakeWord)
{
