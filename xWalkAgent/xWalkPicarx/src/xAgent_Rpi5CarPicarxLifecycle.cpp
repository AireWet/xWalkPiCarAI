...
void XWalkPicarx::loadConfiguration()
{
    ...
    const hal::string calibrationVerifiedText = configStoreObject->get(
    ...
    const hal::float64 motorSpeedCalibration = parseFloat(configStoreObject->get(
    ...
    const hal::fixedarray<hal::int32, 2U> motorDirections = parseMotorDirections(
