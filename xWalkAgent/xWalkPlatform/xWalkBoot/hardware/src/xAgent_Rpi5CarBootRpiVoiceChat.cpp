    ...
    hal::XWalkBoardControl& boardControl, XWalkPicarx& picarx)
{
    ...
    hal::XWalkLanguageModelOllama modelBackend(
        config.get("local_voice_chatbot_ollama_endpoint",
    ...
    const agent::uint32 maximumMessages = parseUnsigned(config.get(
        "local_voice_chatbot_maximum_messages", "20"),
        "local_voice_chatbot_maximum_messages", hal::common::UINT32_MAXIMUM);
