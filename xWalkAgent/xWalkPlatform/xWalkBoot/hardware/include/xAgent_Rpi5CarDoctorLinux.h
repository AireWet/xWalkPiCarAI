...
class XWalkDoctorLinux final
{
    protected:
        ...
        static void inspectGpio(agent::stringvector& lines, agent::stringview device,
        ...
        static void inspectOptionalServices(agent::stringvector& lines,
