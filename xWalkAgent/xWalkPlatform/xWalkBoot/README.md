...
```bash
cmake -S xWalkAgent/xWalkPlatform/xWalkBoot -B xWalkAgent/xWalkPlatform/xWalkBoot/build-host -DXWALK_BOOT_BUILD_HOST_TESTS=ON
cmake --build xWalkAgent/xWalkPlatform/xWalkBoot/build-host --parallel
ctest --test-dir xWalkAgent/xWalkPlatform/xWalkBoot/build-host --output-on-failure
```
