...
class XWalkCameraCapture final
{
    ...
    public:
         ...
         */
        XWalkCameraCapture(hal::XWalkCamera& camera, hal::stringview outputPath);
         ...
         */
        static hal::string captureImage(hal::contextpointer context);
};
