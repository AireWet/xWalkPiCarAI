...
void runModuleTest(const char* moduleDirectory, const char* executableName,
    const char* moduleName, bool needsConfiguration)
{
...
{
    runModuleTest("xWalkGrayscaleCalibration", "xWalkGrayscaleCalibrationTest",
        "grayscale", true);
}

TEST(XWalkAgentCalibrationGroup, ServoMotorCalibration)
{
    runModuleTest("xWalkServoMotorCalibration", "xWalkServoMotorCalibrationTest",
        "servo-motor", true);
}
