...
XWalkServoMotorCalibration::XWalkServoMotorCalibration(XWalkPicarx& picarx,
    agent::contextpointer context, servomotorcalibrationdelaycallback delayOperation,
    ...
    continueCallback(continueOperation)
{
    ...
    {
        XHAL_THROW_INVALID_ARGUMENT("Servo/motor calibration requires complete callbacks");
    }
    resultValue.servoOffsets = {picarx.directionServoCalibration(),
        picarx.cameraPanServoCalibration(), picarx.cameraTiltServoCalibration()};
