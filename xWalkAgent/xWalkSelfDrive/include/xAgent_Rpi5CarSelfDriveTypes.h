 ...
 */
enum class XWalkSelfDriveStatus : hal::uint8
{
    /**
 ...
 */
using selfdrivedelaycallback = hal::boolean (*)(hal::contextpointer context,
 ...
 */
using selfdrivecontinuecallback = hal::boolean (*)(hal::contextpointer context);
