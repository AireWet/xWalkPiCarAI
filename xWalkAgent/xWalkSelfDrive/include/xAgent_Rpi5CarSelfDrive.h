...
class XWalkSelfDrive
{
    private:
        ...
        hal::string soundDirectoryValue{"../xWalkSounds"};
        ...
        hal::boolean hasLastStatus{};
        /** @brief Records an explicit callback failure without exception handling. */
        hal::atomicboolean operationFailedValue{false};
    ...
    protected:
        ...
        static hal::boolean isActionSupported(hal::stringview action) noexcept;
        /** @brief Invokes the application-owned delay operation and records its status. */
        hal::boolean delay(hal::uint32 durationMs);
    ...
    public:
        ...
        XWalkSelfDrive(XWalkPicarx& picarx, hal::XWalkMusic& music,
            ...
            hal::stringview soundDirectory = "../xWalkSounds");
         ...
         */
        hal::boolean doAction(hal::stringview action);
         ...
         */
        void setCancellation(hal::contextpointer context,
         ...
         */
        hal::boolean addAction(hal::stringview action);
         ...
         */
        hal::boolean running() const noexcept;
};
