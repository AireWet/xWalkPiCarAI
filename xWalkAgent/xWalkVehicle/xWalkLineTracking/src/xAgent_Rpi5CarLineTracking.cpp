 ...
 */
XWalkLineTrackingResult XWalkLineTracking::recoverLine(
                            const hal::linetrackervalues& initialReadings
                            )
{
    XWalkLineTrackingResult result{
        initialReadings, XWalkLineTrackingState::Stop, true, false};
    ...
    for (agent::uint32 sampleIndex = 0U;
        sampleIndex < configurationValue.maximumRecoverySamples; ++sampleIndex)
    {
